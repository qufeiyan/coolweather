...
import com.elena.coolweather.gson.DailyForecast;
import com.elena.coolweather.gson.Weather;
  ...
  /*  private TextView comfortText;
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "https://free-api.heweather.com/s6/weather?"
                +"key=38935e45e6ca4342a678ff8d63cfe4b9"+"&location="+weatherId;
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String updateTime = weather.update.localTime.split(" ")[1];
